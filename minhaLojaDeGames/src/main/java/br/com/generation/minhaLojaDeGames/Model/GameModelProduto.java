...
public class GameModelProduto {
	...
	private GameModelCategoria categoria;
	
	
	public GameModelCategoria getCategoria() {
		return categoria;
	}
	public void setCategoria(GameModelCategoria categoria) {
